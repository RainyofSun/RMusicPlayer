...
@interface R_WebViewController ()<UIWebViewDelegate,UINavigationControllerDelegate,UINavigationBarDelegate,NJKWebViewProgressDelegate>
...
@implementation R_WebViewController

-(instancetype)initWithUrl:(NSString *)url{
    if (self = [super init]) {
        self.url = url;
        _progressViewColor = [UIColor colorWithRed:119.0/255.0 green:228.0/255.0 blue:155.0/255.0 alpha:1];
    }
    return self;
}
...
-(void)updateNavigationItems{
    if (self.webView.canGoBack) {
        ...
        [self R_AddNavigationItemWithTitles:@[@"返回"] isLeft:YES target:self action:@selector(leftBtnClick:) tags:@[@2001]];
    }
